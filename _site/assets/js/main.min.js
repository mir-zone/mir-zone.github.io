...
function (e) {
    ...
    e.fn.fitVids = function (t) {
        ...
        function e() {
            u = n.width() - 10, l = n.children().length, c = s[l - 1], c > u ? (n.children().last().prependTo(r), l -= 1, e()) : u > s[l] && (r.children().first().appendTo(n), l += 1, e()), t.attr("count", o - l), l === o ? t.addClass("hidden") : t.removeClass("hidden")
        }
    ...
    function (e) {
        ...
        b.prototype = {
            ...
            _close: function () {
                ...
                r.off("keyup" + m + " focusin" + m), t.ev.off(m), t.wrap.attr("class", "mfp-wrap").removeAttr("style"), t.bgOverlay.attr("class", "mfp-bg"), t.container.attr("class", "mfp-container"),
            ...
            g = function (i, g) {
                ...
                T.cancelScroll = function (e) {
                    ...
                    if (g || y) {
                        ...
                        var w, E, S, k = c(x),
                            A = g ? n : l(y, k, parseInt("function" == typeof d.offset ? d.offset(n, i) : d.offset, 10), d.clip),
                            N = A - b,
                            j = u(),
                            I = 0,
                            L = f(N, d),
                            D = function (t, r) {
                                var o = e.pageYOffset;
                                return t == r || o == r || (r > b && e.innerHeight + o) >= j ? (T.cancelScroll(!0), h(n, r, g), m("scrollStop", d, n, i), w = null, C = null, !0) : void 0
                            },
                            O = function (t) {
                                w || (w = t), I += t - w, E = 0 === L ? 0 : I / L, E = E > 1 ? 1 : E, S = b + N * s(d, E), e.scrollTo(0, Math.floor(S)), D(S, A) || (C = e.requestAnimationFrame(O), w = t)
                            };
                        if (0 === e.pageYOffset && e.scrollTo(0, 0), p(n, g, d), o()) return void e.scrollTo(0, Math.floor(A));
                        m("scrollStart", d, n, i), T.cancelScroll(!0), e.requestAnimationFrame(O)
                    }
                };
                var E = function (t) {
                        if (!t.defaultPrevented && !(0 !== t.button || t.metaKey || t.ctrlKey || t.shiftKey) && "closest" in t.target && (b = t.target.closest(i), b && "a" === b.tagName.toLowerCase() && !t.target.closest(v.ignore) && b.hostname === e.location.hostname && b.pathname === e.location.pathname && /#/.test(b.href))) {
                            var n;
                            try {
                            ...
                            o = o || "#top" !== n ? o : document.documentElement, o && (t.preventDefault(), d(v), T.animateScroll(o, b))
                        }
                    },
                    S = function (e) {
                ...
                var k = function () {
                    ...
                    T.destroy(), v = r(t, g || {}), x = v.header ? document.querySelector(v.header) : null, document.addEventListener("click", E, !1), v.updateURL && v.popstate && e.addEventListener("popstate", S, !1)
                };
                return k(), T
            };
        return g
