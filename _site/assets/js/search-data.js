var store = [{
        ...
        "title": "치 목",
        "excerpt":"마름질 마름재질, 가공을 위해서 재목을 치수에 맞게 자르는 일바심질 마름질한 재목을 다른 부재와 짜 맞추기 위해 깍고 다듬는 일가심질 끌로 파낸 홈이나 구멍의 거친 표면을 가심끌로 곱게 다듬는 일새김질 단청을 하거나 모양을 내기 위해서 끌 등으로 부재의 일부분을 파내는 것바데떼기 부재의 특정부분을 움푹 들어가게 깎아내는 일모접이 부재의 각진 모서리를 날카롭지...","categories": [],
        "tags": [],
        ...
        "tags": ["비"],
        "url": "http://localhost:4000/poems/poetical-works01/"
      },{
        "title": "이렇게 비가 내리면",
        ...
        "tags": ["비"],
        "url": "http://localhost:4000/poems/poetical-works00/"
      },{
        "title": "한여름, 숲에 눕다",
